...
from transformers import BertModel, BertTokenizer, RobertaTokenizer, RobertaModel, DistilBertTokenizer, DistilBertModel, AutoModel, AutoTokenizer 
...
class MultiInferBert(torch.nn.Module):
    def __init__(self, args):
        ...
        # model
        if (self.args.bert_model_path == "roberta-base"):
          self.bert = RobertaModel.from_pretrained(args.bert_model_path)
        elif (self.args.bert_model_path == "bert-base-uncased"):
          self.bert = BertModel.from_pretrained(args.bert_model_path)
        elif self.args.bert_model_path == 'distilbert-base-uncased':
        ...
        # tokenizer
        if self.args.bert_tokenizer_path == "roberta-base":
          self.tokenizer = RobertaTokenizer.from_pretrained(args.bert_tokenizer_path)
        elif self.args.bert_tokenizer_path == "bert-base-uncased":
