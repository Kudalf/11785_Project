...
def load_data_instances(sentence_packs, args):
    ...
    if args.bert_tokenizer_path == "roberta-base":
      ...
      tokenizer = DistilBertTokenizer.from_pretrained(args.bert_tokenizer_path)
    elif args.bert_tokenizer_path == 'vinai/bertweet-base':
      tokenizer = AutoTokenizer.from_pretrained('vinai/bertweet-base')
    elif args.bert_tokenizer_path == 'vinai/bertweet-large':
